...
vals = hfss.post.get_far_field_data(
    setup_sweep_name="Setup1 : LastAdaptive", expression="RealizedGainTotal", domain="Elevation"
)
...
vals3d = hfss.post.get_far_field_data(
    setup_sweep_name="Setup1 : LastAdaptive", expression="RealizedGainTotal", domain="Infinite Sphere1"
)
